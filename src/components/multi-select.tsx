...
>(
  (
    ...
    const toggleAll = () => {
      if (selectedValues.length === (onSearch ? searchResults : options).length) {
        handleClear();
      } else {
        const allValues = (onSearch ? searchResults : options).map((option) => option.value);
          ...
          <Command shouldFilter={onSearch ? false : true}>
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  <div
                    className={cn(
                      ...
                      selectedValues.length === (onSearch ? searchResults : options).length
                ...
                {(onSearch ? searchResults : options).map((option) => {
